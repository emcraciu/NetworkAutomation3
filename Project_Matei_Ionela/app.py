...
SCRIPTS_DIR = Path("/tmp/pycharm_project_342/Project_Matei_Ionela")
PYTHON_INTERPRETER = "/home/osboxes/.virtualenvs/ProjectPyNet3/bin/python"
...
DEVICES = {
    ...
    "12": ("bring_up_gns3_env.py", "testbed.yaml", "Bring Up Devices"),
...
UNITTEST_GROUP = {
    ...
    "test_ospf.py": "OSPF Test",
    "test_perf.py": "Performance Test",
    "test_dhcp.py": "DHCP Test",
...
<body>
  ...
  function runScript(deviceId) {
    fetch("/run/" + deviceId, { method: "POST" })
      .then(r => r.text())
      .then(msg => {
        if (msg.includes("a rulat cu succes")) {
          if (deviceId === "2") {
  ...
  <div class=\"menu\">
    <div class=\"menu-left\">
      ...
      {% endfor %}
      <!-- Dropdown FTD ca buton pe stânga -->
